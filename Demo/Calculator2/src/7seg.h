...
#define SEG_DATA_NON_DECODE_0p		(0b1111110|0b10000000)
#define SEG_DATA_NON_DECODE_1p		(0b0110000|0b10000000)
#define SEG_DATA_NON_DECODE_2p		(0b1101101|0b10000000)
#define SEG_DATA_NON_DECODE_3p		(0b1111001|0b10000000)
#define SEG_DATA_NON_DECODE_4p		(0b0110011|0b10000000)
#define SEG_DATA_NON_DECODE_5p		(0b1011011|0b10000000)
#define SEG_DATA_NON_DECODE_6p		(0b1011111|0b10000000)
#define SEG_DATA_NON_DECODE_7p		(0b1110000|0b10000000)
#define SEG_DATA_NON_DECODE_8p		(0b1111111|0b10000000)
#define SEG_DATA_NON_DECODE_9p		(0b1111011|0b10000000)
#define SEG_DATA_NON_DECODE_Ap		(0b1110111|0b10000000)
#define SEG_DATA_NON_DECODE_Bp		(0b0011111|0b10000000)
#define SEG_DATA_NON_DECODE_Cp		(0b1001110|0b10000000)
#define SEG_DATA_NON_DECODE_Dp		(0b0111101|0b10000000)
#define SEG_DATA_NON_DECODE_Ep		(0b1001111|0b10000000)
#define SEG_DATA_NON_DECODE_Fp		(0b1000111|0b10000000)
#define SEG_DATA_NON_DECODE_DASHp	(0b0000001|0b10000000)
#define SEG_DATA_NON_DECODE_BLANKp	(0b0000000|0b10000000)
...
#define SEG_ADDRESS_ITENSITY		10
